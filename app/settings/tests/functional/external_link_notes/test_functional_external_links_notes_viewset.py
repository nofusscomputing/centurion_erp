...
class ViewSetBase(
    ...
    url_name = '_api_v2_external_link_note'
...
class ExternalLinkModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class ExternalLinkBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class ExternalLinkModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
