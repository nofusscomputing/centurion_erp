...
from settings.models.external_link_notes import ExternalLink, ExternalLinkNotes



class ExternalLinkNotesAPI(
    ...
    view_name: str = '_api_v2_external_link_note'
    ...
    def setUpTestData(self):
        ...
        self.item = self.model.objects.create(
            ...
            model = ExternalLink.objects.create(
                organization = self.organization,
                name = 'note model',
            ),
