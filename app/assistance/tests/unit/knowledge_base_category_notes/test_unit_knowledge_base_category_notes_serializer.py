...
from assistance.serializers.knowledge_base_category_notes import KnowledgeCategoryBaseNotes, KnowledgeBaseCategoryNoteModelSerializer



class KnowledgeCategoryNotesSerializer(
    ...
    model_serializer = KnowledgeBaseCategoryNoteModelSerializer
