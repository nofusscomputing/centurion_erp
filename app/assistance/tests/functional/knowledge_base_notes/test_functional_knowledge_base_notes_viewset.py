...
class ViewSetBase(
    ...
    url_name = '_api_v2_knowledge_base_note'
    ...
    def setUpTestData(self):
        ...
        self.global_org_item = self.viewset.model.objects.create(
            ...
            model = self.viewset.model.model.field.related_model.objects.create(
                organization = self.global_organization,
                title = 'note model global_organization',
                content = 'body',
            ),
            created_by = self.view_user,
            modified_by = self.view_user,
...
class KnowledgeBaseModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class KnowledgeBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class KnowledgeBaseModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
