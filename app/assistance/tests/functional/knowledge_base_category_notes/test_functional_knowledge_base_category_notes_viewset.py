...
class ViewSetBase(
    ...
    url_name = '_api_v2_knowledge_base_category_note'
...
class KnowledgeBaseCategoryModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class KnowledgeBaseCategoryModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class KnowledgeBaseCategoryModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
