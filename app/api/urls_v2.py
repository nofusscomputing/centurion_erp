...
router.register('access/role', role.ViewSet, basename='_api_v2_role')
router.register('access/role/(?P<model_id>[0-9]+)/notes', role_notes.ViewSet, basename='_api_v2_role_note')
