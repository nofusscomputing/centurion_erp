...
from itam.viewsets.operating_system_notes import ViewSet
...
class OperatingSystemModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class OperatingSystemBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class OperatingSystemModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
