...
from itam.viewsets.software_category_notes import ViewSet
...
class ViewSetBase(
    ...
    url_name = '_api_v2_software_category_note'
...
class SoftwareCategoryModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class SoftwareCategoryBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class SoftwareCategoryModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
