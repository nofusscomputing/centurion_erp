...
from itam.models.software_category_notes import SoftwareCategory, SoftwareCategoryNotes



class SoftwareCategoryNotesAPI(
    ...
    view_name: str = '_api_v2_software_category_note'
    ...
    def setUpTestData(self):
        ...
        self.item = self.model.objects.create(
            ...
            model = SoftwareCategory.objects.create(
                organization = self.organization,
                name = 'note model',
            ),
