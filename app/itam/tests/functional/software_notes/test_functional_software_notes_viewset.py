...
from itam.viewsets.software_notes import ViewSet
...
class SoftwareModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class SoftwareBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class SoftwareModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
