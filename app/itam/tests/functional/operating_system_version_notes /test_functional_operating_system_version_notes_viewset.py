...
class ViewSetBase(
    ...
    url_name = '_api_v2_operating_system_version_note'
...
class OperatingSystemVersionModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class OperatingSystemVersionBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class OperatingSystemVersionModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
