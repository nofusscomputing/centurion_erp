...
from itam.viewsets.device_model_notes import ViewSet
...
class ViewSetBase(
    ...
    url_name = '_api_v2_device_model_note'
...
class DeviceModelModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class DeviceModelBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class DeviceModelModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
