...
from itam.models.device_type_notes import DeviceType, DeviceTypeNotes



class DeviceTypeNotesAPI(
    ...
    view_name: str = '_api_v2_device_type_note'
    ...
    def setUpTestData(self):
        ...
        self.item = self.model.objects.create(
            ...
            model = DeviceType.objects.create(
                organization = self.organization,
                name = 'note model',
            ),
