...
from itam.viewsets.device_type_notes import ViewSet
...
class ViewSetBase(
    ...
    url_name = '_api_v2_device_type_note'
...
class DeviceTypeModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class DeviceTypeBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class DeviceTypeModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
