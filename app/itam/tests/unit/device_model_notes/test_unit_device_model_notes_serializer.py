...
from itam.serializers.device_model_notes import DeviceModelNotes, DeviceModelNoteModelSerializer



class DeviceModelNotesSerializer(
    ...
    model_serializer = DeviceModelNoteModelSerializer
