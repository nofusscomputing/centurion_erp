...
from itam.serializers.device_type_notes import DeviceTypeNotes, DeviceTypeNoteModelSerializer



class DeviceTypeNotesSerializer(
    ...
    model_serializer = DeviceTypeNoteModelSerializer
