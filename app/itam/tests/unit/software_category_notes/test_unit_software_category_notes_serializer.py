...
from itam.serializers.software_category_notes import SoftwareCategoryNotes, SoftwareCategoryNoteModelSerializer



class SoftwareCategoryNotesSerializer(
    ...
    model_serializer = SoftwareCategoryNoteModelSerializer
