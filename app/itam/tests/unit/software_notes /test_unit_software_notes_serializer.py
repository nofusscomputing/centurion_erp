...
from itam.serializers.software_notes import SoftwareNotes, SoftwareNoteModelSerializer



class SoftwareNotesSerializer(
    ...
    model_serializer = SoftwareNoteModelSerializer
