...
from config_management.serializers.config_group_notes import ConfigGroupNotes, ConfigGroupNoteModelSerializer



class ConfigGroupNotesSerializer(
    ...
    model_serializer = ConfigGroupNoteModelSerializer
