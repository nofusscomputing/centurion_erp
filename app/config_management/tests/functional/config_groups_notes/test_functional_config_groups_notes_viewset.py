...
from config_management.viewsets.config_group_notes import ViewSet
...
class ConfigGroupsModelNotesPermissionsAPI(
    ViewSetBase,
    ModelNotesPermissionsAPI,
    TestCase,
):
...
class ConfigGroupsBaseModelNotesSerializer(
    ViewSetBase,
    ModelNotesSerializer,
    TestCase,
):
...
class ConfigGroupsModelNotesMetadata(
    ViewSetBase,
    ModelNotesMetadata,
    TestCase,
